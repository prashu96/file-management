...
public class generateotp extends javax.swing.JFrame implements Runnable{
Connection conn;
int s=0;
Thread th;
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(791, 607));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(generateotp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new generateotp().setVisible(true);
            }
        });
    }
